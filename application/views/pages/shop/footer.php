<footer class="footer-area">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div class="footer-widget mb-30">
                                <div class="footer-info-wrapper">
                                    ...
                                    <a href="<?php echo base_url('home')?>"><img alt="" src="http://localhost:8888/petshop/assets/home/img/logo/logo.png"></a>
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="footer-widget">
                                ...
                                <div class="payment-img">
                                    <a href="index.html">
                                        <img src="http://localhost:8888/petshop/assets/home/img/icon-img/payment.png" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <script src="<?php echo base_url('assets/home/')?>js/vendor/jquery-1.12.0.min.js"></script>
        ...
        <script src="<?php echo base_url('assets/home/')?>js/elevetezoom.js"></script>
        <script src="<?php echo base_url('assets/home/')?>js/ajax-mail.js"></script>
