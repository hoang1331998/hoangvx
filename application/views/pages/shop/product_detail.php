            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-img">
                        <img id="" style="object-fit: cover; height:550px" src="<?php echo base_url('assets/')?>img/pet/<?php echo $row->image?>"
                            data-zoom-image="<?php echo base_url('assets/')?>img/pet/<?php echo $row->image?>" alt="zoom" />
                        <div id="gallery" class="mt-12 product-dec-slider owl-carousel">
                            <a data-image="<?php echo base_url('assets/')?>img/pet/<?php echo $row->image?>"
                                data-zoom-image="<?php echo base_url('assets/')?>img/pet/<?php echo $row->image?>">
                    ...
                    <div class="product-details-content">
                        ...
                        <div class="product-list-action">
                            <div class="product-list-action-left">
                                <a class="addtocart-btn" href="<?php echo base_url("cart/add/").$row->id?>" title="Add to cart">
                                    <i class="ion-bag"></i>
                                    Add to cart
                                </a>
                            </div>
