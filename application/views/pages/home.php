...
<body>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12 col-sm-7">
                            <div class="slider-content slider-animated-1 pt-114">
                                ...
                                <div class="slider-btn">
                                    <a class="animated" href="<?php echo base_url("shop")?>">SHOP NOW</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-12 col-sm-5">
                            <div class="slider-single-img slider-animated-1">
                                <img class="animated"
                                    src="<?php echo base_url('assets/home/')?>img/slider/slider-single-img.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-5 col-12">
                            <div class="slider-single-img slider-animated-1">
                                <img class="animated"
                                    src="<?php echo base_url('assets/home/')?>img/slider/slider-single-img-2.png"
                                    alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="single-food-category cate-padding-1 text-center mb-30">
                        <a href="<?php echo base_url("shop/catalog/0")?>">
                            <div class="single-food-hover-2">
                                <img style="object-fit:cover; height:250px"
                                    src="<?php echo base_url('assets/')?>img/pet/pet3.jpg" alt="">
                            </div>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single-food-category cate-padding-2 text-center mb-30">
                        <a href="<?php echo base_url("shop/catalog/1")?>">
                            <div class="single-food-hover-2">
                                <img style="object-fit:cover; height:250px"
                                    src="<?php echo base_url('assets/')?>img/pet/pet1.jpg" alt="">
                            </div>
                            <div class="single-food-content">
                                <h3>Cats</h3>
                            </div>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single-food-category cate-padding-3 text-center mb-30">
                        <a href="<?php echo base_url("shop/catalog/3")?>">
                            <div class="single-food-hover-2">
                                <img style="object-fit:cover; height:250px"
                                    src="<?php echo base_url('assets/')?>img/pet/pet2.jpg" alt="">
                            </div>
                            <div class="single-food-content">
                                <h3>Birds</h3>
                            </div>
            ...
            <div class="row">
                    ...
                    <div class="product-wrapper mb-10">
                        <div class="product-img">
                            <a href="product-details.html">
                                <img src="<?php echo base_url('assets/home/')?>img/product/product-4.jpg" alt="">
                            </a>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="product-wrapper mb-10">
                        <div class="product-img">
                            <a href="product-details.html">
                                <img src="<?php echo base_url('assets/home/')?>img/product/product-5.jpg" alt="">
                            </a>
                            <div class="product-action">
                                <a title="Quick View" data-toggle="modal" data-target="#exampleModal" href="#">
                                    <i class="ti-plus"></i>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="product-wrapper mb-10">
                        <div class="product-img">
                            <a href="product-details.html">
                                <img src="<?php echo base_url('assets/home/')?>img/product/product-6.jpg" alt="">
                            </a>
                            <div class="product-action">
                                <a title="Quick View" data-toggle="modal" data-target="#exampleModal" href="#">
                                    <i class="ti-plus"></i>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="product-wrapper mb-10">
                        <div class="product-img">
                            <a href="product-details.html">
                                <img src="<?php echo base_url('assets/home/')?>img/product/product-9.jpg" alt="">
                            </a>
                            <div class="product-action">
                                <a title="Quick View" data-toggle="modal" data-target="#exampleModal" href="#">
                                    <i class="ti-plus"></i>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="product-wrapper mb-10">
                        <div class="product-img">
                            <a href="product-details.html">
                                <img src="<?php echo base_url('assets/home/')?>img/product/product-10.jpg" alt="">
                            </a>
                            <div class="product-action">
                                <a title="Quick View" data-toggle="modal" data-target="#exampleModal" href="#">
                                    <i class="ti-plus"></i>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="product-wrapper mb-10">
                        <div class="product-img">
                            <a href="product-details.html">
                                <img src="<?php echo base_url('assets/home/')?>img/product/product-11.jpg" alt="">
                            </a>
                            <div class="product-action">
                                <a title="Quick View" data-toggle="modal" data-target="#exampleModal" href="#">
                                    <i class="ti-plus"></i>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="deal-img wow fadeInLeft">
                        <a href="#"><img src="<?php echo base_url('assets/home/')?>img/banner/banner-2.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="deal-content">
                        ...
                        <p>Lorem ipsum dolor sit amet, co adipisicing elit, sed do eiusmod tempor incididunt labore et
                            dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercita ullamco laboris nisi ut
    ...
    <div class="testimonial-area pt-90 pb-70 bg-img"
        style="background-image:url(http://localhost:8888/petshop/assets/home/img/banner/banner-1.jpg); object-fit:cover;">
        <div class="container">
            <div class="row">
                    ...
                    <div class="testimonial-wrap">
                        ...
                        <div class="testimonial-image-slider text-center">
                            <div class="sin-testiImage">
                                <img src="<?php echo base_url('assets/home/')?>img/testi/3.jpg" alt="">
                                <h3>Robiul Islam</h3>
                                <h5>Customer</h5>
                            </div>
                            <div class="sin-testiImage">
                                <img src="<?php echo base_url('assets/home/')?>img/testi/4.jpg" alt="">
                                <h3>Robiul Islam</h3>
                                <h5>Customer</h5>
                            </div>
                            <div class="sin-testiImage">
                            ...
                            <div class="sin-testiImage">
                                <img src="<?php echo base_url('assets/home/')?>img/testi/5.jpg" alt="">
                                <h3>T. T. Rayed</h3>
                                <h5>CEO</h5>
                            </div>
                        </div>
                        <div class="testimonial-shap">
                            <img src="<?php echo base_url('assets/home/')?>img/icon-img/testi-shap.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="service-content text-center mb-30 service-color-1">
                        <img src="<?php echo base_url('assets/home/')?>img/icon-img/shipping.png" alt="">
                        <h4>FREE SHIPPING</h4>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="service-content text-center mb-30 service-color-2">
                        <img src="<?php echo base_url('assets/home/')?>img/icon-img/support.png" alt="">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="service-content text-center mb-30 service-color-3">
                        <img src="<?php echo base_url('assets/home/')?>img/icon-img/money.png" alt="">
                        <h4>MONEY RETURN</h4>
                        ...
                        <div class="quick-view-learg-img">
                            <div class="quick-view-tab-content tab-content">
                                <div class="tab-pane active show fade" id="modal1" role="tabpanel">
                                    <img src="<?php echo base_url('assets/home/')?>img/quick-view/l1.jpg" alt="">
                                </div>
                                <div class="tab-pane fade" id="modal2" role="tabpanel">
                                    <img src="<?php echo base_url('assets/home/')?>img/quick-view/l2.jpg" alt="">
                                </div>
                                <div class="tab-pane fade" id="modal3" role="tabpanel">
                                    <img src="<?php echo base_url('assets/home/')?>img/quick-view/l3.jpg" alt="">
                                </div>
                            </div>
                        </div>
