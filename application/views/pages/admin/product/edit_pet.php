                                    ...
                                    <form action="#" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><span
                                                    ...
                                                    value="<?php echo $Pet->id?>" class="form-control"></div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><textarea name="description"
                                                    ...
                                                    class="form-control"><?php echo $Pet->description?></textarea></div>
                                        </div>
                                        <!-- price -->
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input"
                                            ...
                                            <div class="col-12 col-md-9"><input type="text" id="price"
                                                    value="<?php echo $Pet->price?>" name="price" placeholder=""
                                    ...
                                    <select name="species_id" id="selectLg" class="form-control-lg form-control" value="<?php echo $Pet->species_id?>">
                                            ...
                                            <div class="col col-md-9">
                                                <div class="form-check-inline form-check">
                                                    <label for="inline-radio1" class="form-check-label ">
                                                        <input type="radio" id="inline-radio" name="gender" value="1"
                                                            class="form-check-input"
                                                            checked=<?php if ($Pet->gender==1) echo "checked"?>>Male
                                                    </label>
                                                    <label for="inline-radio2" class="form-check-label ">
                                                        <input style="margin-left: 10px;" type="radio" id="inline-radio"
                                                            name="gender" value="0" class="form-check-input"
                                                            checked=<?php if ($Pet->gender==0) echo "checked"?>>Female
                                                    </label>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><input type="text" id="password-input"
                                                    value="<?php echo $Pet->sale_id?>" name="sale_id" placeholder=""
                                                    class="form-control"></div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><input type="file" id="image"
                                                    value="<?php echo $Pet->image?>" name="image"
