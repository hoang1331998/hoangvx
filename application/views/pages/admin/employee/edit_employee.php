                                    ...
                                    <form action="#" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><span
                                                    ...
                                                    value="<?php echo $employee->id?>" class="form-control"></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="name" class=" form-control-label">Họ
                                                    tên </label></div>
                                            <div class="col-12 col-md-9"><span
                                                    style="color:red !important; font-style: italic;"><?php echo form_error('name')?></span><input
                                                    type="text" name="name" id="name"
                                                    value="<?php echo $employee->name?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><span
                                                    ...
                                                    value="<?php echo $employee->email?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><span
                                                    ...
                                                    value="<?php echo $employee->username?>" class="form-control"></div>
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><span
                                                    ...
                                                    value="<?php echo $employee->password?>" class="form-control"></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="password-input"
                                                ...
                                                <div class="form-check-inline form-check">
                                                    ...
                                                    <label for="male" class="form-check-label ">
                                                        <input type="radio" id="male" name="gender" value="0"
                                                            ...
                                                            checked="<?php if ($employee->gender === 0) echo "checked"; ?>">Male
                                                    </label>
                                                    <label for="female" class="form-check-label ">
                                                        <input type="radio" id="female" name="gender"
                                                            checked="<?php if ($employee->gender === 1) echo 'checked';?>"
                                                            value="1" class="form-check-input"
                                                            style="margin-left: 10px;" style="margin-left: 10px;">Female
                                                    </label>
                                                ...
                                                <div class="form-check-inline form-check">
                                                    <label for="admin" class="form-check-label ">
                                                        <input type="radio" id="admin" name="role" value="0"
                                                            class="form-check-input"
                                                            checked="<?php if ($employee->role_id==0) echo 'checked';?>">Admin
                                                    </label>
                                                    <label for="employee" class="form-check-label ">
                                                        <input type="radio" id="employee" name="role" value="1"
                                                            ...
                                                            checked="<?php if ($employee->role_id==1) echo 'checked';?>">Employee
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><input type="file" id="file-input" name="image"
                                                    value="<?php echo $employee->image?>" class="form-control-file">
                                            </div>
                                        </div>
